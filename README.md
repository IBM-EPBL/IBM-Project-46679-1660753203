...
<html>
  <body style="background-color:powderblue;">
    ...
    <h4> COLLEGE NAME : RATHINAM TECHNICAL CAMPUS</h4>
    <h4> TEAM MENTOR : Mr.SRIRAM SURYA S</h4>
  </body>
  </html>
